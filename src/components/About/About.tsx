...
const About = () => {
  return (
    <div id="about" className="about lg:py-12  flex flex-col gap-4 justify-center items-center w-full h-full overflow-hidden md:mt-24 sm:mt-24 mt-24">
        ...
        <Tiles/>
        <p className="text-center text-slate-600 tracking-tight max-w-[64vw] text-sm ">Hi, my name is Alina, and I am a passionate full stack web and mobile apps developer. I specialize in creating user-friendly applications that provide seamless experiences across various devices and platforms.</p>
